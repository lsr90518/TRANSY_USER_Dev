...
NSString *const MJRefreshHeaderStateIdleText = @"データ更新";
NSString *const MJRefreshHeaderStatePullingText = @"離すとリフレッシュ";
NSString *const MJRefreshHeaderStateRefreshingText = @"更新中...";
